package app.dicky.meetthearrogance.customComponent;
...
import app.dicky.meetthearrogance.utils.DimensionUtils;
...
//    }
    ...
    private int measureSize(int measureSpec) {
        int defSize =   DimensionUtils.dip2px(getContext(), DEF_DRAW_SIZE);
