...
public class MainFragment extends FragmentActivity {
    ...
    public void InitImage() {
        image = (ImageView) findViewById(R.id.icon_del_focused);
        bmpW = BitmapFactory.decodeResource(getResources(), R.drawable.icon_del_focused).getWidth();
    ...
    public void InitViewPager() {
        ...
        Fragment fiveFragment = new TTSActivity();
