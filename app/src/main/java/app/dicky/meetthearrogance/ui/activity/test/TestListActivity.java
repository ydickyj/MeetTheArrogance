package app.dicky.meetthearrogance.ui.activity.test;
...
//                        startActivity(new Intent(TestListActivity.this, PublishActivity.class));
                    ...
                    case 6:
                        startActivity(new Intent(TestListActivity.this, MainTabActivity.class));
                    case 7:
                        startActivity(new Intent(TestListActivity.this, MainFragment.class));
                        break;
                }
            }
        });
