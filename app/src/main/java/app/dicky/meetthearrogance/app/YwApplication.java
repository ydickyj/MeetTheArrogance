package app.dicky.meetthearrogance.app;
...
import app.dicky.meetthearrogance.BuildConfig;
...
public class YwApplication extends Application {
    public static final String TAG = "YwApplication";
...
//在做打包混淆时，关闭debug模式，避免消耗不必要的资源
    ...
    private void showNotification(EMMessage emMessage) {
        ...
        Intent chat = new Intent(this, ExActivity.class);
